...
파일명은 **`[식별자]_[YYYYMMDDHHmm].md`** 형식을 따릅니다.
...
-   **식별자**: 커밋 메시지 형식을 직관적으로 표현하며, 스코프 유무에 따라 형태가 달라집니다.
    ...
    -   *Jira 이슈가 없는 경우, 앞의 `[이슈 키]_` 부분만 생략됩니다.*
...
-   **스코프 O**: `.../APPLY-670_refactor(jinhak-cash)-컨트롤러-분리_202508251430.md`
-   **스코프 X**: `.../APPLY-671_docs-API-문서-업데이트_202508251432.md`
